...
import authorsPageInitialPathsBb732Resource from '../../../resources/authors-page-initial-paths-bb732'
import authorsPageInitialProps70be5Resource from '../../../resources/authors-page-initial-props-70be5'
...
export async function getStaticPaths() {
  const response = await authorsPageInitialPathsBb732Resource({})
...
export async function getStaticProps(context) {
  const response = await authorsPageInitialProps70be5Resource({
    ...context?.params,
